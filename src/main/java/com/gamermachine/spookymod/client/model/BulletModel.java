package com.gamermachine.spookymod.client.model;

import com.gamermachine.spookymod.SpookyMod;
...
public class BulletModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SpookyMod.MODID, "bullet_model"), "");
